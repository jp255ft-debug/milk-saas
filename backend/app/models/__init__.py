...
from sqlalchemy import (Boolean, CheckConstraint, Column, Date, DateTime, 
                        ForeignKey, Numeric, String, UniqueConstraint, func)
...
class FinancialCategory(Base):
    ...
    __table_args__ = (CheckConstraint(type.in_(['variable_cost', 'fixed_cost', 'revenue']), name='check_category_type'),)
