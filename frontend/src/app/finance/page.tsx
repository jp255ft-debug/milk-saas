...
export default function FinancePage() {
  ...
  const fetchCategories = async () => {
    try {
      ...
      throw err; // para ser capturado pelo Promise.all
    }
  };
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link href="/finance/new" className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
          Nova Transação
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-green-100 p-4 rounded shadow">
          ...
          <p className="text-2xl font-bold text-green-700">{formatCurrency(summary.revenues)}</p>
        </div>
        ...
        <div className="bg-blue-100 p-4 rounded shadow">
          ...
          <p className={`text-2xl font-bold ${summary.balance >= 0 ? 'text-blue-700' : 'text-red-700'}`}>
      ...
      <div className="mt-6">
        <Link href="/finance/cost-per-liter" className="bg-purple-600 text-white px-4 py-2 rounded hover:bg-purple-700">
